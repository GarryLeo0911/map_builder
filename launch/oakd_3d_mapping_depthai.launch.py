...
def generate_launch_description():
    """Launch OAK-D driver and map_builder with 3D visualization using depthai-ros"""
    ...
    # OAK-D Driver Node using depthai-ros
    oakd_node = Node(
